...
src_idx2word = {src_vocab[key]: key for key in src_vocab}   # 源字典转换成 索引: 字
...
d_ff = 2048     # 前向传播隐藏层维度(隐藏单元个数)
d_k = d_v = 64  # K(=Q), V的维度
n_layers = 6    # 有多少个 encoder 和 decoder
n_heads = 8     # Multi-Head Attention 设置为 8
